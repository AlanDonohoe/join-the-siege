...
class FileNameValidator:
    ...
    def call(cls, files: Dict) -> FileNameValidation:
        ...
        if not file:
            return FileNameValidation(valid=False, error_message="No file part in the request")
        ...
        if not cls._allowed_file(file.filename):
            return FileNameValidation(valid=False, error_message="File type not allowed")
